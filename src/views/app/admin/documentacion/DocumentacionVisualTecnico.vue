...
export default {
  ...
  data() {
    return {
      ...
      archivosEdit:[],
      editItem:'',
      apiBase: url + "/audiovisual-tecnicos",
      show: false,
      archivos: [],
      loadedRatio: 0,
      file: false,
      ...
      server: {
        ...
        process: {
          ...
          ondata: fd => {
            ...
            fd.append("ref", "audiovisual-tecnico");
  ...
  methods: {
    async editarItem(){
      ...
      try{
        ...
        let {data} = await axios.put( `/audiovisual-tecnicos/${x.id}`, {ano:x.ano, 'titulo':x.titulo, 'descripcion': x.descripcion} ,setting );
    ...
    async deleteItem(){
      ...
      try{
        ...
        let setting = { headers: header };
        let promesa1 = axios.delete( `/audiovisual-tecnicos/${x.id}`, setting )
    ...
    async crearItem() {
      try {
        ...
        let { data } = await axios.post("/audiovisual-tecnicos", this.x, setting);
