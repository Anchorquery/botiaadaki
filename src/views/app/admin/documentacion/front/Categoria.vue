  ...
  <b-container>
    ...
    <b-row class="mb-4" v-if="isLoad">
      <b-col md="3" v-for="(x, i) in items" :key="i" class="mb-4">
        <div  class="wrapper-item" v-if="x.archivo" @click="seleccionItem(x, true)">
          <div class="pdf-wrapper" v-if="!x.archivo ? '' : x.archivo.mime == 'application/pdf'">
            <!--<pdf
          ...
          <div
            class="pdf-wrapper images clearfix"
            v-if="x.archivo.mime == 'video/mp4' || x.archivo.mime == 'video/quicktime' "
          >
            <b-img
    ...
    <template>
      ...
      >
        ...
        <b-form
          v-if="
            itemSeleccionado.archivo
              ? itemSeleccionado.archivo.mime != 'video/mp4' && itemSeleccionado.archivo.mime != 'video/quicktime'
              : ''
          "
        >
          <b-container v-if="itemSeleccionado.archivo.mime == 'image/jpeg' || itemSeleccionado.archivo.mime == 'image/png'">
            <b-row>
              <b-col md="5">
        ...
        <b-form           v-if="
          ...
          <b-container v-if='itemSeleccionado.archivo.mime == "application/x-zip-compressed" ||
...
import ListPageListing from "../categoria/Paginacion.vue";
