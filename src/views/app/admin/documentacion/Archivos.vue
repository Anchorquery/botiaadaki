<template>
  ...
  <!-- <b-row>
    ...
    <b-row class="mb-4" v-if="isLoad" >
      <b-col md="3" v-for="(x, i) in items" :key="i" class="mb-4">
        <div class="wrapper-item" @click="seleccionItem(x)">
          <div class="pdf-wrapper">
            <pdf
              :src="x.tarifa ? `${url + x.tarifa.url}` : ''"
    ...
    <!-- crear -->
    <template>
      <b-modal ref="modal-add" id="modal-add" centered title="Crear tarifa">
        <b-form>
          <b-container>
            <b-row>
              <b-col md="6">
              ...
              <b-col md="12">
                <b-form-group label="Descripción" class="label-input-form mb-4">
                  <b-form-textarea
                    ...
                    placeholder="Descripción del tarifa"
                    rows="3"
                    max-rows="6"
                  ></b-form-textarea>
                </b-form-group>
    ...
    <!-- editar -->
    <template>
      <b-modal ref="modal-edit" id="modal-edit" centered title="Editar tarifa">
        <b-form>
          <b-container>
            <b-row>
              <b-col md="6">
            ...
            <b-row>
              <b-col md="5">
                ...
                <pdf
                  ...
                  v-if="show"
                  :src="
                    !itemSeleccionado ? '' : url + itemSeleccionado.tarifa.url
                  "
                  :page="pagePdf"
              ...
              <b-col md="7">
                <div class="text-center">
                  <h3 class="h3 mb-4">Datos del tarifa</h3>
                  <div class="text-left">
                    ...
                    <p class=" h5 sub-title">
                      <span class="  strong">Año del tarifa:</span>
                    ...
                    <div class="botonera">
                      <a
                        ...
                        :href="
                          !itemSeleccionado
                            ? ''
                            : url + itemSeleccionado.tarifa.url
                        "
  ...
  <template>
      ...
      <b-modal id="modal-delete" ref="modal-delete" title="Eliminacion de tarifa">
        <b-alert show variant="danger"
          >¿Estás seguro que desea eliminar el tarifa?
          </b-alert
        >
      ...
      server: {
        ...
        process: {
          ...
          ondata: fd => {
            ...
            fd.append("ref", "tarifa");
            fd.append("field", "tarifa");
            return fd;
          }
        }
      }
  ...
  methods: {
    async editarItem(){
      ...
      try{
        ...
        let {data} = await axios.put( `/tarifas/${x.id}`, {ano:x.ano, 'titulo':x.titulo, 'descripcion': x.descripcion} ,setting );
    ...
    async auxliarEdit(x){
      try{
        ...
        let promesa2 = axios.delete(`/upload/files/${x.tarifa.id}`, setting);
    ...
    async deleteItem(){
      ...
      try{
        ...
        let setting = { headers: header };
        let promesa1 = axios.delete( `/tarifas/${x.id}`, setting )
    ...
    async crearItem() {
      try {
        ...
        let { data } = await axios.post("/tarifas", this.x, setting);
